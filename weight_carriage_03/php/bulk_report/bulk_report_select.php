  ...
  <body>
    ...
    <div class="header">
      <div class="home-menu pure-menu pure-menu-horizontal pure-menu-fixed">
        <a class="pure-menu-heading" href="">Насыпь</a>
      </div>
    </div>
    ...
    <div class="content">  
      <form class="pure-form" action="report.php" method="post">
        ...
        <fieldset>
          <input type="text" name="vagon" maxlength=16 class="pure-input-1-4" placeholder="Номер вагона">
        </fieldset>
        <fieldset>
          <div class="pure-g">
            <div class="pure-u-12-24">
              <input type="checkbox" name="in_kg">
              <span>вес в килограммах</span>
            </div>
          </div>
        </fieldset>
