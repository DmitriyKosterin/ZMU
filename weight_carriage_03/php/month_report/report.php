...
<html lang="ru">
  ...
  <body>
    ...
    <?php
      ...
      $datefirst=$year1 . ".$month1" . ".01";                                //дата начала месяца (первое число месяца)
      $last_day_month=cal_days_in_month(CAL_GREGORIAN, $month1, $year1);     //число дней в месяце
      $datelast=$year1 . ".$month1" . ".$last_day_month";                    //дата конца месяца  (последнее число месяца)
    ...
    ?>
    <div>
      <h3>ЋтчЮт по отгрузке за <?="$month_name" . " $year1 г."?> </h3>
      <?= "<h4>Дата/время формирования отчёта: " . "$str_curdatetime</h4>" ?>
    </div>
    ...
    <p>
      <table class="tabledata">
        <thead style=display:table-header-group>
          <tr>
            <th rowspan=2>—исло</th>
            <th rowspan=2>‚ид<br>отгрузки</th>
